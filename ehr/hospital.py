...
class Concealed_by_patient(Role):
    ...
    def canActivate_1(self, pat): # A4.2.1
        ...
        # Reason: [11] unable to bind vars {'ids', 'from_time', 'to_time', 'subjects', 'groups', 'authors'} in constraint compare_seq(self.what, (subj, ids, authors, groups, subjects, from_time, to_time))
        #
    ...
    def canActivate_2(self, ag): # A4.2.2
        ...
        #
        # << AUTOMATIC TRANSLATION FAILURE >>
        # Reason: [12] unable to bind vars {'ids', 'from_time', 'to_time', 'subjects', 'groups', 'authors'} in constraint compare_seq(self.what, (role.pat, ids, authors, groups, subjects, from_time, to_time))
        #
        # !!! USING HAND TRANSLATION INSTEAD !!!
        #
        return {
...
def count_concealed_by_patient(pat): # A4.2.7
    ...
    #
    # << AUTOMATIC TRANSLATION FAILURE >>
    # Reason: [13] unable to bind vars {'ids', 'from_time', 'to_time', 'subjects', 'what', 'groups', 'authors'} in constraint compare_seq(what, (pat, ids, authors, groups, subjects, from_time, to_time))
    #
    # !!! USING HAND TRANSLATION INSTEAD !!!
    #
    return len({
